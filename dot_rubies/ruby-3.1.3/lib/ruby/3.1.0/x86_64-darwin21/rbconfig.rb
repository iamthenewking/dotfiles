...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/jeff/.rubies/ruby-3.1.3")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/jeff/.rubies/ruby-3.1.3' '--with-opt-dir=/usr/local/opt/readline:/usr/local/opt/libyaml:/usr/local/opt/gdbm' '--with-openssl-dir=/usr/local/opt/openssl@3'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/jeff/.rubies/ruby-3.1.3"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/usr/local/opt/readline/lib -L/usr/local/opt/libyaml/lib -L/usr/local/opt/gdbm/lib -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/usr/local/opt/readline/include -I/usr/local/opt/libyaml/include -I/usr/local/opt/gdbm/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong -L/usr/local/opt/readline/lib -L/usr/local/opt/libyaml/lib -L/usr/local/opt/gdbm/lib -L/usr/local/lib"
