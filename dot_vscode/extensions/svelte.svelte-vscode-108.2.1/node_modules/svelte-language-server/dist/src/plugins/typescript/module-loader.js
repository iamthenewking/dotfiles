 ...
 */
function createSvelteModuleLoader(getSnapshot, compilerOptions, tsSystem, tsModule) {
    ...
    function resolveModuleName(name, containingFile, containingSourceFile, index) {
        ...
        const tsResolvedModuleWithFailedLookup = tsModule.resolveModuleName(name, containingFile, compilerOptions, typescript_1.default.sys, tsModuleCache, undefined, mode);
        const tsResolvedModule = tsResolvedModuleWithFailedLookup.resolvedModule;
        if (tsResolvedModule) {
            return tsResolvedModuleWithFailedLookup;
        }
        const svelteResolvedModuleWithFailedLookup = tsModule.resolveModuleName(name, containingFile, compilerOptions, svelteSys, undefined, undefined, mode);
