...
class LSAndTSDocResolver {
    constructor(docManager, workspaceUris, configManager, options) {
        ...
        this.watchers = new fileCollection_1.FileMap(this.tsSystem.useCaseSensitiveFileNames);
    ...
    async invalidateModuleCache(filePath) {
        await (0, service_1.forAllServices)((service) => service.invalidateModuleCache(filePath));
    }
    /**
        ...
        return {
            ...
            readFile: (path, encoding) => {
                if (path.endsWith('package.json') && !this.watchers.has(path)) {
                    this.watchers.set(path, watchFile(path, this.onPackageJsonWatchChange.bind(this), 3000));
                }
