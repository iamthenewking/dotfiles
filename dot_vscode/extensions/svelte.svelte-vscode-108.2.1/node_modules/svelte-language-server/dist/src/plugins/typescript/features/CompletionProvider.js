...
class CompletionsProviderImpl {
    ...
    async getCompletions(document, position, completionContext, cancellationToken) {
        ...
        if (svelteNode?.type === 'InlineComponent' &&
            ...
            if (isWhitespaceAfterStartTag) {
                ...
                return this.getCompletionListForDirectiveOrProps(attributeContext, componentInfo, document, wordRange, eventAndSlotLetCompletions, tsDoc);
            }
        }
    ...
    getCompletionListForDirectiveOrProps(attributeContext, componentInfo, document, wordRange, eventAndSlotLetCompletions, tsDoc) {
